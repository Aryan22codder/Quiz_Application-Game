...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        add(qno);
        question = new JLabel();
        question.setBounds(100, 450, 900, 25);
        question.setFont(new Font("Poppins", Font.PLAIN, 20));
        add(question);
        ...
        lifeline.setBounds(1000, 540, 100, 30);
        ...
        submit.setBounds(1000, 580, 100, 30);
